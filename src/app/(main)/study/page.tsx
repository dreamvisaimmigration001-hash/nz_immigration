    ...
    <main id="main" className="main">
            ...
            <div className="container">
              <nav className="breadcrumbs breadcrumbs--landingpage" aria-label="Breadcrumbs">
                <ol className="breadcrumbs__list">
                  ...
                  <li className="breadcrumbs__list-item breadcrumbs__list-item--current" aria-current="page"> Study </li>
                </ol>
              </nav>
            </div>
          </div>
          <div className="container hero__container-flex">
            <div className="hero__text-wrapper">
              <h1 className="hero__title" tabIndex={-1}>
                <span className="hero__title-main"> Study </span>
                <span lang="mi" className="hero__title-te-reo" dir="ltr">Ako</span>
              </h1>
              <p className="hero__summary">Find out about visas that let you study in New Zealand. If you are an education provider, learn about the rules for bringing students to New Zealand. </p>
            </div>
            <div className="hero__links-wrapper">
              <p className="hero__links-header">Popular pages </p>
              <div>
                <ul className="hero__links-list">
                  <li className="hero__links-item"><Link href="#" className="btn btn--small btn--secondary"> Fee Paying Student Visa </Link></li>
                  <li className="hero__links-item"><Link href="#" className="btn btn--small btn--secondary"> Post Study Work Visa </Link></li>
                  <li className="hero__links-item"><Link href="#" className="btn btn--small btn--secondary" target="_blank" rel="noopener noreferrer"> Study with New Zealand </Link></li>
                  <li className="hero__links-item"><Link href="#" className="btn btn--small btn--secondary" target="_blank" rel="noopener noreferrer"> Register interest in studying in New Zealand </Link></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <div className="landing-page__elemental">
        <section className="block bg childpagetileblock bg--white">
          <div className="container block__container" id="e5108">
                      ...
                      <div className="tile__content">
                        <div className="tile__title-wrapper">
                          <h2 className="tile__title">
                            <span className="tile__first-words">Study </span>
                        ...
                        <p className="tile__text"> Learn about the visas you can study on while in New Zealand, and who can help you with your application. </p>
                      </div>
                    </Link>
                  </li>
                  <li className="tile-block__list-item">
                    <Link href="#" className="tile" data-not-external-icon="">
                      <div className="tile__content">
                        <div className="tile__title-wrapper">
                          <h2 className="tile__title">
                            <span className="tile__first-words">Once you have a student </span>
                            <span className="tile__title-icon-wrapper">
                        ...
                        <p className="tile__text"> Find out about working on a student visa, and how to check or change the conditions of your visa. </p>
                      </div>
                    </Link>
                  </li>
                  <li className="tile-block__list-item">
                    <Link href="#" className="tile" data-not-external-icon="">
                      <div className="tile__content">
                        <div className="tile__title-wrapper">
                          <h2 className="tile__title">
                            <span className="tile__first-words">After you finish your </span>
                            <span className="tile__title-icon-wrapper">
                              <span className="tile__last-word">study</span>
                              <span className="tile__arrow">
                                <svg aria-hidden="true" focusable="false" viewBox="0 0 23 17" xmlns="http://www.w3.org/2000/svg">
                                  <path d="m14.635 16.255 7.944-7.15a.812.812 0 0 0 .278-.605.813.813 0 0 0-.278-.605L14.635.748A.99.99 0 0 0 13.97.5c-.245 0-.49.085-.676.252a.793.793 0 0 0-.005 1.206l6.322 5.685H.952C.427 7.643 0 8.027 0 8.5s.427.857.952.857h18.66l-6.324 5.686a.793.793 0 0 0 .007 1.204c.188.169.434.253.677.253.242 0 .48-.082.663-.245Z"></path>
                                </svg>
                        ...
                        <p className="tile__text"> Find out about staying in New Zealand to work after you finish your study. </p>
                      </div>
                    </Link>
                  </li>
                  <li className="tile-block__list-item">
                    <Link href="#" className="tile" data-not-external-icon="">
                      <div className="tile__content">
                        <div className="tile__title-wrapper">
                          <h2 className="tile__title">
                            <span className="tile__first-words">For education </span>
                            <span className="tile__title-icon-wrapper">
                              <span className="tile__last-word">providers</span>
                              <span className="tile__arrow">
                                <svg aria-hidden="true" focusable="false" viewBox="0 0 23 17" xmlns="http://www.w3.org/2000/svg">
                                  <path d="m14.635 16.255 7.944-7.15a.812.812 0 0 0 .278-.605.813.813 0 0 0-.278-.605L14.635.748A.99.99 0 0 0 13.97.5c-.245 0-.49.085-.676.252a.793.793 0 0 0-.005 1.206l6.322 5.685H.952C.427 7.643 0 8.027 0 8.5s.427.857.952.857h18.66l-6.324 5.686a.793.793 0 0 0 .007 1.204c.188.169.434.253.677.253.242 0 .48-.082.663-.245Z"></path>
                                </svg>
                        ...
                        <p className="tile__text"> Learn the rules for approved education providers, and how to attract international students and apply on their behalf. Find out about processing times for applications. </p>
                      </div>
                    </Link>
                  </li>
                </ul>
        ...
        <section className="block bg visa-find-block">
          <div className="container block__container" id="e5110">
            ...
            <form className="visa-find-block__form">
              <div className="visa-find-block__field">
                <div id="visa-find-step-first-step" className="visa-find-step">
                  ...
                  <span>
                    <div dir="auto" className="v-select vs--single vs--searchable v-select--visa-step" style={{ '--multiselect-visa-step-dropdown-left-position': '-465.859375px', '--multiselect-visa-step-dropdown-right-position': '-445.71875px' } as any}>
                      <div id="vs2__combobox" className="vs__dropdown-toggle" role="combobox" aria-expanded="false" aria-owns="vs2__listbox"
                        ...
                        <div className="vs__selected-options">
                          <span className="vs__selected">study</span>
                  ...
                  <div id="visa-find-step-study-1" className="visa-find-step visa-find-step--next">
                    <label htmlFor="visa-find-step-input-study-1" className="visa-find-step__question-label">I plan to study for</label>
                    <span>
                      <div dir="auto" className="v-select vs--single vs--searchable v-select--visa-step" style={{ '--multiselect-visa-step-dropdown-left-position': '-273.328125px', '--multiselect-visa-step-dropdown-right-position': '-635.671875px' } as any}>
                        ...
                        aria-controls="vs4__listbox" aria-label="">
                          <div className="vs__selected-options">
                            <div className="vs__input-box">
                              <input className="vs__search vs__search_position" placeholder="select" id="visa-find-step-input-study-1" aria-autocomplete="list" aria-labelledby="vs4__combobox" aria-controls="vs4__listbox" type="search" autoComplete="off" defaultValue="" />
                            </div>
                          </div>
                          <div className="vs__actions">
                            <button type="button" className="vs__clear" title="Clear Selected" aria-label="Clear Selected" style={{ display: 'none' }}>
